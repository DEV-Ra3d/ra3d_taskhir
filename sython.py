...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@RC_RY"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('ابشر هنا رعد')
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | ra3d 𝒕𝒆𝒂𝒎⛤')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة | ra3d 𝒕𝒆𝒂𝒎⛤')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def _(event):
      await event.reply("""السـورس يعمـل |رعد *
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
